...
> 本机安装状态（版本/渠道/环境特殊处理/限制）见 [references/install-notes.md](references/install-notes.md)。
> 注意：本机运行前需 `export HOME=/opt/data`，否则 agent-reach 访问 /root 报 PermissionError。
